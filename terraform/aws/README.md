...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | AWS region to use | `string` | `"eu-central-1"` | no |
| <a name="input_branch"></a> [branch](#input\_branch) | GitOps branch to use | `string` | `"main"` | no |
| <a name="input_cidr_block"></a> [cidr\_block](#input\_cidr\_block) | CIDR for main VPC | `string` | `"10.0.16.0/20"` | no |
| <a name="input_eks_cluster_version"></a> [eks\_cluster\_version](#input\_eks\_cluster\_version) | Version of EKS cluster | `string` | `"1.24"` | no |
| <a name="input_ssh_key_path"></a> [ssh\_key\_path](#input\_ssh\_key\_path) | Path for new ssh key for all EC2 instances | `string` | `"~/.ssh/devsecops_aws_terraform.pem"` | no |
| <a name="input_stack_name"></a> [stack\_name](#input\_stack\_name) | Stack name to tag your resources | `string` | `"devsecops"` | no |
| <a name="input_worker_instanse_size"></a> [worker\_instanse\_size](#input\_worker\_instanse\_size) | Worker node type | `string` | `"r5a.large"` | no |
...
">
    ...
    <div class="metadata">
      <ul>
        ...
        <li>
          ...
          <span class="value">2023-08-29 11:33:04 &#43;05</span>
        </li>
      </ul>
    </div>
  ...
  <tr class="resource top-level">
    ...
    <tr class="tags">
      <td class="name">
        ...
        <span>Environment=Test, Managed\_by=Terraform, Module=EKS, Name=/aws/eks/devsecops/cluster, Owner=devsecops, Project=DevSecOps</span>
      </td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.63 per GB</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.0324 per GB</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.0063 per GB</td>
  ...
  <tr class="resource top-level">
    ...
    <tr class="tags">
      <td class="name">
        ...
        <span class="label">Tags:</span>
        <span>Environment=Test, Managed\_by=Terraform, Module=EKS, Owner=devsecops, Project=DevSecOps</span>
      </td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      EKS cluster
        ...
        <td class="monthly-cost">$73.00</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      Customer master key
        ...
        <td class="monthly-quantity">1</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.03 per 10k requests</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.10 per 10k requests</td>
  ...
  <tr class="resource top-level">
    <td class="name">
      ...
      module.eks.module.self\_managed\_node\_group[&#34;spot&#34;].aws\_autoscaling\_group.this[0]
    </td>
    ...
    <tr class="tags">
      <td class="name">
        ...
        <span class="label">Tags:</span>
        <span>Module=EKS, Name=spot</span>
      </td>
  ...
  <tr class="resource">
    <td class="name">
      ...
      <span class="arrow">&#8627;</span>
      module.eks.module.self\_managed\_node\_group[&#34;spot&#34;].aws\_launch\_template.this[0]
    </td>
  ...
  <tr class="cost-component">
    <td class="name">
      &nbsp;&nbsp;&nbsp;&nbsp;
      <span class="arrow">&#8627;</span>
      Instance usage (Linux/UNIX, spot, r5a.large)
    </td>
        ...
        <td class="monthly-cost">$34.02</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      EC2 detailed monitoring
        ...
        <td class="monthly-quantity">7</td>
      
      
        <td class="unit">metrics</td>
      
      
      
      
        <td class="monthly-cost">$2.10</td>
  ...
  <tr class="resource top-level">
    ...
    <tr class="tags">
      <td class="name">
        ...
        <span class="label">Tags:</span>
        <span>Environment=Test, Managed\_by=Terraform, Module=EKS, Name=ex-aws-eu-central-1a, Owner=devsecops, Project=DevSecOps</span>
      </td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      NAT gateway
        ...
        <td class="monthly-cost">$37.96</td>
  ...
  <tr class="cost-component">
    <td class="name">
      ...
      <td colspan="3" class="usage-cost">Cost depends on usage: $0.052 per GB</td>
      ...
      <tr class="total">
        ...
        <td class="monthly-cost">$148.08</td>
      </tr>
    </tbody>
  </table>
    ...
    <div class="warnings">
      <p>56 cloud resources were detected:<br />∙ 5 were estimated, 3 of which include usage-based costs, see https://infracost.io/usage-file<br />∙ 51 were free, rerun with --show-skipped to see details</p>
    </div>
  </body>
</html>
<!-- END_TF_DOCS -->